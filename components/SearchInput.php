...
class SearchInput extends BaseComponent
{
    ...
    {
        return [
            'name'        => 'spanjaan.sitesearch::lang.searchInput.title',
            'description' => 'spanjaan.sitesearch::lang.searchInput.description',
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'useAutoComplete' => [
                'title'       => 'spanjaan.sitesearch::lang.searchInput.properties.use_auto_complete.title',
                'type'        => 'checkbox',
                'default'     => 1,
            ],
            'autoCompleteResultCount' => [
                'title'             => 'spanjaan.sitesearch::lang.searchInput.properties.auto_complete_result_count.title',
                'type'              => 'string',
            ...
            'searchPage'              => [
                'title'       => 'spanjaan.sitesearch::lang.searchInput.properties.search_page.title',
                'description' => 'spanjaan.sitesearch::lang.searchInput.properties.search_page.description',
                'type'        => 'dropdown',
            ],
        ];
    }
    ...
    public function getSearchPageOptions()
    {
        ...
        return ['' => trans('spanjaan.sitesearch::lang.searchInput.properties.search_page.null_value'),] + $options;
    }
