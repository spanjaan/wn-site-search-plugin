...
use SpAnjaan\Sitesearch\Classes\ResultCollection;
use SpAnjaan\Sitesearch\Classes\SearchService;
use Request;
use Url;

/**
 * SearchResults Component
 * @package SpAnjaan\Sitesearch\Components
 */
class SearchResults extends BaseComponent
{
    ...
    {
        return [
            'name'        => 'spanjaan.sitesearch::lang.searchResults.title',
            'description' => 'spanjaan.sitesearch::lang.searchResults.description',
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'resultsPerPage'    => [
                'title'             => 'spanjaan.sitesearch::lang.searchResults.properties.results_per_page.title',
                'type'              => 'string',
            ...
            'showProviderBadge' => [
                'title'       => 'spanjaan.sitesearch::lang.searchResults.properties.provider_badge.title',
                'description' => 'spanjaan.sitesearch::lang.searchResults.properties.provider_badge.description',
                'type'        => 'checkbox',
                'default'     => 1,
            ],
            'noResultsMessage'  => [
                'title'             => 'spanjaan.sitesearch::lang.searchResults.properties.no_results.title',
                'description'       => 'spanjaan.sitesearch::lang.searchResults.properties.no_results.description',
                'type'              => 'string',
                'default'           => 'Your search returned no results.',
                'showExternalParam' => false,
            ],
            'visitPageMessage'  => [
                'title'             => 'spanjaan.sitesearch::lang.searchResults.properties.visit_page.title',
                'description'       => 'spanjaan.sitesearch::lang.searchResults.properties.visit_page.description',
                'type'              => 'string',
                'default'           => 'Visit page',
                'showExternalParam' => false,
            ],
